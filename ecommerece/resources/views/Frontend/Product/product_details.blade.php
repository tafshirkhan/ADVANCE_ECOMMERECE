                    ...
                    <div class="row  wow fadeInUp">
                        ...
                        <div class='col-sm-6 col-md-7 product-info-block'>
                            <div class="product-info">
                                ...
                                <!--For selecting product color and size  -->
                                ...
                                <!--End selecting product color and size  -->
                                ...
                                <div class="products">
                                    ...
                                    <div class="product">
                                        <div class="product-image">
                                            <div class="image">
                                                <a
                                                    href="{{ url('product/details_info/' . $relatedproduct->id . '/' . $relatedproduct->product_slug) }}"><img
                                                        src="{{ asset($relatedproduct->product_thumb) }}"
                                                        alt=""></a>
                                            </div><!-- /.image -->
                                        ...
                                        <div class="product-info text-left">
                                            <h3 class="name"><a
                                                    href="{{ url('product/details_info/' . $relatedproduct->id . '/' . $relatedproduct->product_slug) }}">{{ $relatedproduct->product_name }}</a>
                                            </h3>
                                            <div class="rating rateit-small"></div>
                                            ...
                                            @if ($relatedproduct->discount_price == null)
                                                <div class="product-price"> <span class="price">
                                                        {{ $relatedproduct->selling_price }}</span> </div>
                                            @else
                                                <div class="product-price"> <span class="price">
                                                        {{ $relatedproduct->selling_price }}</span><span
                                                        class="price-before-discount">{{ $relatedproduct->discount_price }}</span>
                                                </div>
                                            @endif
                                            <!-- /.product-price -->
