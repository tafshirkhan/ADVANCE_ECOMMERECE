                        ...
                        <div class="owl-carousel sidebar-carousel special-offer custom-carousel owl-theme outer-top-xs">
                            ...
                            <div class="item">
                                <div class="products special-product">
                                    ...
                                    @foreach ($specialoffer as $specialproduct)
                                        <div class="product">
                                                ...
                                                <div class="row product-micro-row">
                                                    <div class="col col-xs-5">
                                                        <div class="product-image">
                                                            <div class="image"> <a
                                                                    href="{{ url('product/details_info/' . $specialproduct->id . '/' . $specialproduct->product_slug) }}">
                                                                    <img src="{{ asset($specialproduct->product_thumb) }}"
                                                                        alt="">
                                                                </a> </div>
                                                            <!-- /.image -->
                                                    ...
                                                    <div class="col col-xs-7">
                                                        <div class="product-info">
                                                            <h3 class="name"><a
                                                                    href="{{ url('product/details_info/' . $specialproduct->id . '/' . $specialproduct->product_slug) }}">{{ $specialproduct->product_name }}</a>
                                                            </h3>
                                                            <div class="rating rateit-small"></div>
                                                            <div class="product-price"> <span class="price">
                                                                    {{ $specialproduct->selling_price }} </span>
                                                            </div>
                                                            <!-- /.product-price -->
                        ...
                        <div class="owl-carousel sidebar-carousel special-offer custom-carousel owl-theme outer-top-xs">
                            ...
                            <div class="item">
                                <div class="products special-product">
                                    ...
                                    @foreach ($specialdeals as $dealsproduct)
                                        <div class="product">
                                            <div class="product-micro">
                                                <div class="row product-micro-row">
                                                    <div class="col col-xs-5">
                                                        <div class="product-image">
                                                            <div class="image"> <a
                                                                    href="{{ url('product/details_info/' . $dealsproduct->id . '/' . $dealsproduct->product_slug) }}">
                                                                    <img src="{{ asset($dealsproduct->product_thumb) }}"
                                                                        alt="">
                                                                </a> </div>
                                                            <!-- /.image -->
                                                    ...
                                                    <div class="col col-xs-7">
                                                        <div class="product-info">
                                                            <h3 class="name"><a
                                                                    href="{{ url('product/details_info/' . $dealsproduct->id . '/' . $dealsproduct->product_slug) }}">{{ $dealsproduct->product_name }}
                                                                </a></h3>
                                                            <div class="rating rateit-small"></div>
                                                            <div class="product-price"> <span class="price">
                                                                    {{ $dealsproduct->selling_price }} </span> </div>
                                                            <!-- /.product-price -->
            ...
            <div class="col-xs-12 col-sm-12 col-md-9 homebanner-holder">
                ...
                <div id="product-tabs-slider" class="scroll-tabs outer-top-vs wow fadeInUp">
                    ...
                    <div class="tab-content outer-top-xs">
                        ...
                        <!-- THIS IS FOR SHOWING ALL THE PRODUCTS -->
                                            ...
                                            <div class="products">
                                                <div class="product">
                                                    <div class="product-image">
                                                        <div class="image">
                                                            <a
                                                                href="{{ url('product/details_info/' . $product->id . '/' . $product->product_slug) }}"><img
                                                        ...
                                                        <div>
                                                            @if ($product->discount_price == null)
                                                                <div style="background-color: rgb(4, 82, 3)"
                                                                    class="tag new">
                                                                    <span>new</span>
                                                                </div>
                                                            @else
                                                                <div style="background-color: red" class="tag new">
                                                    ...
                                                    <div class="product-info text-left">
                                                        <h3 class="name"><a
                                                                href="{{ url('product/details_info/' . $product->id . '/' . $product->product_slug) }}">{{ $product->product_name }}</a>
                                                        </h3>
                                                        <div class="rating rateit-small"></div>
                        ...
                        <!--THIS IS FOR SHOWING ALL THE PRODUCTS. END -->



                        <!-- THIS IS FOR SHOWING CATEGORISE ALL THE PRODUCTS -->
                        @php
                            $categories = App\Models\Category::orderBy('category_name', 'ASC')->get();
                        @endphp
                            ...
                            <div class="tab-pane" id="category{{ $category->id }}">
                                <div class="product-slider">
                                    <div class="owl-carousel home-owl-carousel custom-carousel owl-theme"
                                        ...
                                        @forelse ($productByCategory as $product)
                                            <div class="item item-carousel">
                                                <div class="products">
                                                    <div class="product">
                                                        <div class="product-image">
                                                            ...
                                                            <div>
                                                                @if ($product->discount_price == null)
                                                                    <div style="background-color: rgb(4, 82, 3)"
                                                                        class="tag new"><span>new</span></div>
                                                                @else
                                        ...
                                        @empty
                                            <h5 class="text-danger">No products are available right now</h5>
                                        @endforelse
                                    </div>
                                    <!-- /.home-owl-carousel -->
                                </div>
                        ...
                        <!-- THIS IS FOR SHOWING CATEGORISE ALL THE PRODUCTS. END -->
                ...
                <section class="section featured-product wow fadeInUp">
                    <h3 class="section-title">{{ $skipcategory->category_name }}</h3>
                    <div class="owl-carousel home-owl-carousel custom-carousel owl-theme outer-top-xs">

                        @foreach ($skipproduct as $skipproduct)
                            <div class="item item-carousel">
                                <div class="products">
                                    <div class="product">
                                        <div class="product-image">
                                            <div class="image"> <a
                                                    href="{{ url('product/details_info/' . $skipproduct->id . '/' . $skipproduct->product_slug) }}"><img
                                                        src="{{ asset($skipproduct->product_thumb) }}"
                                                        alt=""></a>
                                            </div>
                                            <!-- /.image -->
                                        ...
                                        <div class="product-info text-left">
                                            <h3 class="name"><a
                                                    href="{{ url('product/details_info/' . $skipproduct->id . '/' . $skipproduct->product_slug) }}">{{ $skipproduct->product_name }}</a>
                                            </h3>
                                            <div class="rating rateit-small"></div>
                                            <div class="description"></div>
                                            ...
                                            @if ($skipproduct->discount_price == null)
                                                <div class="product-price"> <span class="price">
                                                        {{ $skipproduct->selling_price }}</span> </div>
                                            @else
                                                <div class="product-price"> <span class="price">
                                                        {{ $skipproduct->selling_price }}</span><span
                                                        class="price-before-discount">{{ $skipproduct->discount_price }}</span>
                                                </div>
                                            @endif
                                            <!-- /.product-price -->
                                ...
                                <div class="item">
                                    <div class="blog-post">
                                        ...
                                        <div class="blog-post-info text-left">
                                            <h3 class="name"><a href="#">{{ $post->post_title }}</a></h3>
                                            <span class="info">{{ $post->created_at }}
                                            </span>
                                            <p class="text">{!! Str::limit($post->post_details, 100) !!}</p>
