    ...
    <table width="100%" style="background: #F7F7F7; padding:0 20px 0 20px;">
        <tr>
            <td valign="top">
                ...
                <h2 style="color: green; font-size: 26px;"><strong>Happy Shopping</strong></h2>
            </td>
            <td align="right">
                <pre class="font">
               Head Office
               Email:happyshopping@gmail.com
               Mob: 01792345675 <br>
               Dhaka<br>
        ...
        <tr>
            <td>
                <p class="font" style="margin-left: 20px;">
                    ...
                    @endphp
                    <strong>Address:</strong> {{ $state }}, {{ $district }}, {{ $division }} <br>
    ...
    <table width="100%">
        ...
        <tbody>
            ...
            @foreach ($orderItem as $item)
                <tr class="font">
                    <td align="center">
                        <img src="{{ public_path($item->products->product_thumb) }} " height="60px;" width="60px;"
                            alt="">
                    </td>
                    <td align="center">{{ $item->products->product_name }}</td>
                    <td align="center">
                        @if ($item->size == null)
                            ---
                        @else
