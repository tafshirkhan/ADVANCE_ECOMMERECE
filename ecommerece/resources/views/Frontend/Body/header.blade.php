                        ...
                        <li>
                            @auth
                                <a href="{{ route('login') }}"><i class="icon fa fa-user"></i><a
                                        href="{{ route('dashboard') }}">User Profile</a></a>
                            @else
                ...
                <div class="col-xs-12 col-sm-12 col-md-2 animate-dropdown top-cart-row">
                    ...
                    <div class="dropdown dropdown-cart"> <a href="#" class="dropdown-toggle lnk-cart"
                            ...
                            <div class="items-cart-inner">
                                ...
                                <div class="total-price-basket"> <span class="lbl"></span> <span class="total-price">
                                        <span class="sign">Tk: </span>
                                        <span class="value" id="cartSubTotal" style="width: 30%"></span> </span>
                                </div>
                            </div>
                        </a>
                        <ul class="dropdown-menu">
                            ...
                            <li>
                                <!-- Mini Cart option start-->
                                <div id="miniCart"></div>

                                <!-- Mini Cart option end-->
